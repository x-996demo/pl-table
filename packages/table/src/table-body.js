...
import HzSelection from '../../hzselection';
import HzHeader from '../../HzHeader';
...
export default {
  ...
  methods: {
    mousedown(index) {
      this.start = true;
      this.store.states.selecting = [index];
    },
      ...
      return (<tr
        ...
        on-mouseleave={ this.handleMouseLeave }>
        {
          columns.map((column, cellIndex) => {
            ...
            // console.log(this.store.dragmousemove);
            return (
              <td
                ...
                rowspan={ rowspan }
                colspan={ colspan }
                on-mouseup={ () => this.store.dragmouseup(() => true, row.$ix) }
                on-mousemove={ () => this.store.dragmousemove(row.$ix) }
